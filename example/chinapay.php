...
$unionPay = new AppPay(dirname(__DIR__) . '/static/pay/unionpay/pay.ini', function($path){return str_replace('WEBROOT', dirname(__DIR__), $path);});
...
$order_info = array(
    ...
    'orderId' => date('YmdHis') . mt_rand(1000,9999),  //商户订单号，8-32位数字字母，不能含“-”或“_”
	'txnTime' => date('YmdHis'),  //订单发送时间，格式时YYYYMMDDhhmmss
