...
class Sms{
	...
	public static function init($accessKeyId, $accessKeySecret){
		if(self::$acsClient == null){
			...
			// 初始化AcsClient用于发起请求
			self::$acsClient = new DefaultAcsClient($profile);
		}
	}
	 ...
	 * @return stdClass
	 * @example Sms::send('林忠仁', 'SMS_86610162', '18968596872', array('code'=>'123456'))
	 */
	public static function send($signName, $templateCode, $phoneNumbers, $templateParam = null, $outId = null) {
	
		if(self::$acsClient == null) return array('success'=>false, 'msg'=>'请先调用Sms::init(...)'); 
	 ...
	 * @return stdClass
	 * @example Sms::query('18968596872', date('Ymd'), 10, 1) 
	 */
	public static function query($phoneNumbers, $sendDate, $pageSize = 10, $currentPage = 1, $bizId=null) {
